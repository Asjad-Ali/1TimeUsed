<template>
  <q-card class="product-card my-card">
    <q-img
    ...
    <q-card-section>
      ...
      <p class="ellipsis text-subtitle2">Realme 2 city</p>
      <p class="prise text-center">RS:22000</p>

      <div class="flex justify-between">
        <small class="q-mr-sm"> lahore pakistan </small>
